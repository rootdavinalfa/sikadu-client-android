...
import kotlinx.android.synthetic.main.frame_schedulestudent.view.*
...
class DashboardSchedule : Fragment() {
    ...
    var defaultContainer: MaterialCardView? = null
    ...
    private fun getScheduleDetail(year: String, quart: String) {
        APINetworkRequest(
            requireActivity(),
            getScheduleDetail,
            constant.scheduleUrl + "$year/$quart/" + token,
            APINetworkRequest.CODE_GET_REQUEST,
            null
        )
    }
